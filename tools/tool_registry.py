...
class ToolExecutor:
    """Khởi tạo các service và điều phối lệnh từ Agent."""
    ...
    def _wrap_schedule_event(self, title: str, start_time: str, end_time: str):
        return self.calendar_svc.create_calendar_event(title, start_time, end_time)
    ...
    def execute(self, tool_name: str, parameters: Dict[str, Any]) -> ToolExecutionResult:
        ...
        print(f"[Tool Executor] Đang chạy {tool_name} với tham số: {parameters}")
