...
from config import GAP_AUTO_RUN
...
class BackgroundJobManager:
    ...
    def auto_check_gmail(self):
        ...
        Task: 
        1. Check the latest emails, if there is anything important, summarize the report. If email content NEED schedule and just ONLY email content NEED schedule, add text below your answer with <b></b> tag to ask sếp to allow scheduling.
