...
class AgentOrchestrator:
    ...
    def think(self, session, context, available_tools):
        ...
        if hasattr(message_obj, 'tool_calls') and message_obj.tool_calls:
            ...
            tool_calls_dict = [{"id": tc.id, "type": "function", "function": {"name": tc.function.name, "arguments": tc.function.arguments}} for tc in message_obj.tool_calls]
    ...
    def act(self, session, tool_calls):
        ...
        for tool_call in tool_calls:
            ...
            try:
                ...
                executed_results.append({"id": tool_call.id, "name": tool_name, "res": json.dumps({"error": "Invalid JSON in tool arguments."})})
                continue
            ...
            executed_results.append({"id": tool_call.id, "name": tool_name, "res": result.to_json_string()})
